    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <section className="relative overflow-hidden pt-20 pb-24 sm:pt-32 sm:pb-32">
        ...
        <div className="mx-auto max-w-4xl px-6 text-center">
          {/* Badge */}
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-deepsea-200 dark:border-deepsea-800/60 bg-deepsea-50 dark:bg-deepsea-950/30 px-4 py-1.5 text-xs font-semibold text-deepsea-700 dark:text-deepsea-300">
